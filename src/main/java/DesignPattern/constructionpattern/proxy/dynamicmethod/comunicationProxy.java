...
/**
 * @Description: 动态代理在Java中有着广泛的应用，如Spring AOP，Hibernate数据查询、测试框架的后端mock、RPC，Java注解对象获取等。
...
public class comunicationProxy implements InvocationHandler {
    ...
    public Object invoke(Object proxy, Method method, Object[] args) throws Throwable {
        ...
        Object returnValue;
        try {
            System.out.println("开始事务2");//@Before
            returnValue = method.invoke(target, args);
            System.out.println("提交事务2-@After-returning");//@After-returning
        } catch (Exception e) {
            System.out.println("抛出异常");//@After-throwing
            return null;
        }finally {
            System.out.println("结束事务-@After");//@After
        }
        return returnValue;
